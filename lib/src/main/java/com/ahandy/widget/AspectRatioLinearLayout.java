...
/**
 * {@link android.widget.LinearLayout} which forces itself to be laid out according the aspect ratio.
 */
public class AspectRatioLinearLayout extends LinearLayout {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mAspectRatio = Math.abs(a.getFloat(R.styleable.AspectRatioLinearLayout_aspectRatio, 1));
        a.recycle();
    }
