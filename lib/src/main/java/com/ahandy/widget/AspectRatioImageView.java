...
/**
 * {@link android.widget.ImageView} which forces itself to be laid out according the aspect ratio.
 */
public class AspectRatioImageView extends ImageView {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mAspectRatio = Math.abs(a.getFloat(R.styleable.AspectRatioImageView_aspectRatio, 1));
        a.recycle();
    }
