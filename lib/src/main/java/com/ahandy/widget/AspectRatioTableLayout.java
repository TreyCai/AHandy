...
/**
 * {@link android.widget.TableLayout} which forces itself to be laid out according the aspect ratio.
 */
public class AspectRatioTableLayout extends TableLayout {
    ...
    public AspectRatioTableLayout(Context context) {
        super(context);
    }

    public AspectRatioTableLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    private void init(Context context, AttributeSet attrs) {
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.AspectRatioTableLayout);
        mAspectRatio = Math.abs(a.getFloat(R.styleable.AspectRatioTableLayout_aspectRatio, 1));
        a.recycle();
    }
