...
/**
 * {@link android.widget.VideoView} which forces itself to be laid out according the aspect ratio.
 */
public class AspectRatioVideoView extends VideoView {
    ...
    private void init(Context context, AttributeSet attrs) {
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.AspectRatioVideoView);
        mAspectRatio = Math.abs(a.getFloat(R.styleable.AspectRatioVideoView_aspectRatio, 1));
        a.recycle();
    }
