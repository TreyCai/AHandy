...
/**
 * {@link android.widget.Button} which forces itself to be laid out according the aspect ratio.
 */
public class AspectRatioButton extends Button {
    ...
    public AspectRatioButton(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init(context, attrs);
    }

    private void init(Context context, AttributeSet attrs) {
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.AspectRatioButton);
        mAspectRatio = Math.abs(a.getFloat(R.styleable.AspectRatioButton_aspectRatio, 1));
        a.recycle();
    }
