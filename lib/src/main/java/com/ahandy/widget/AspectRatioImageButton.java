...
/**
 * {@link android.widget.ImageButton} which forces itself to be laid out according the aspect ratio.
 */
public class AspectRatioImageButton extends ImageButton {
    ...
    private void init(Context context, AttributeSet attrs) {
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.AspectRatioImageButton);
        mAspectRatio = Math.abs(a.getFloat(R.styleable.AspectRatioImageButton_aspectRatio, 1));
        a.recycle();
    }
