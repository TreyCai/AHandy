...
/**
 * {@link android.widget.GridLayout} which forces itself to be laid out according the aspect ratio.
 */
public class AspectRatioGridLayout extends GridLayout {
    ...
    public AspectRatioGridLayout(Context context) {
        super(context);
    }

    public AspectRatioGridLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public AspectRatioGridLayout(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init(context, attrs);
    }

    private void init(Context context, AttributeSet attrs) {
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.AspectRatioGridLayout);
        mAspectRatio = Math.abs(a.getFloat(R.styleable.AspectRatioGridLayout_aspectRatio, 1));
        a.recycle();
    }
