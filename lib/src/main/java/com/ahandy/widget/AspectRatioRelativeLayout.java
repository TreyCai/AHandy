...
/**
 * {@link android.widget.RelativeLayout} which forces itself to be laid out according the aspect ratio.
 */
public class AspectRatioRelativeLayout extends RelativeLayout {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mAspectRatio = Math.abs(a.getFloat(R.styleable.AspectRatioRelativeLayout_aspectRatio, 1));
        a.recycle();
    }
