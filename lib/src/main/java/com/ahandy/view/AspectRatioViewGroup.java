...
/**
 * {@link android.view.ViewGroup} which forces itself to be laid out according the aspect ratio.
 */
public abstract class AspectRatioViewGroup extends ViewGroup {
    ...
    public AspectRatioViewGroup(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public AspectRatioViewGroup(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init(context, attrs);
    }

    private void init(Context context, AttributeSet attrs) {
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.AspectRatioViewGroup);
        mAspectRatio = Math.abs(a.getFloat(R.styleable.AspectRatioViewGroup_aspectRatio, 1));
        a.recycle();
    }
