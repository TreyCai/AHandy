...
/**
 * {@link android.view.View} which forces itself to be laid out according the aspect ratio.
 */
public class AspectRatioView extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mAspectRatio = Math.abs(a.getFloat(R.styleable.AspectRatioView_aspectRatio, 1));
        a.recycle();
    }
